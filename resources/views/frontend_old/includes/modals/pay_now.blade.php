            ...
            <div class="modal-body">
                ...
                <div class="tab-content">
                    <div id="stripe-wrapper" class="tab-pane stripe-wrapper @if( (!user()->subscription()->stripe_id && !user()->subscription()->paypal_id) || (user()->subscription()->stripe_id && !user()->subscription()->paypal_id)) active @endif">
                        <form action="{{ route('frontend.subscription.checkout') }}" id="stripe_form" method="post">
                            ...
                            <div id="card-element" style="background: #ffffff;
                                 ...
                                 border-radius: 4px;
                                 border: 1px solid #cfd7df;"></div>

                            <div class="mt-3">
                                <button onclick="ym(73260880, 'reachGoal', 'placeorder'); return true;" type="submit" class="btn btn-sm btn-success" id="pay_now" style="    display: block !important;
                                        width: calc(100% - 30px) !important;
                                        height: 40px !important;
                                        margin: 40px 15px 0 !important;
                                        background-color: #0849D0 !important;
                                        border-radius: 4px !important;
                                        color: #fff !important;
                                        text-transform: uppercase !important;
                                        font-weight: 600 !important;
                                        cursor: pointer !important;     font-size: 16px !important;" >Place order</button>
                            </div>
                        </form>
                    ...
                    <div id="paypal-wrapper" class="tab-pane paypal-wrapper @if(!user()->subscription()->stripe_id && user()->subscription()->paypal_id) active @endif">
                        ...
                        <div class="paypal-powered-by"><style>
                                .paypal-powered-by {
                                    text-align: center;
                                    margin: 10px auto;
                                    height: 14px;
