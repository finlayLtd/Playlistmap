        ...
        <div class="modal-content" style="    padding: 10%;">
            ...
            <div class="modal-body">
                ...
                <div class="input-wrapper payment-wrapper">
                    ...
                    <label  for="stripe-input-radio"><img alt="" class="logo stripe-logo" src="{{asset("images/icons/stripe-logo.webp")}}" /></label>
                </div>
                <div class="input-wrapper payment-wrapper">
                    <input id="paypal-input-radio" name="payment-radio" type="radio" data-target="#paypal-wrapper">
                    <label for="paypal-input-radio"><img alt="" class="logo paypal-logo" src="{{asset("images/icons/paypal.webp")}}" /></label>
                </div>
                <br>
                @endif
                <div class="tab-content">
                    <div id="stripe-wrapper" class="tab-pane stripe-wrapper @if( (!user()->subscription()->stripe_id && !user()->subscription()->paypal_id) || (user()->subscription()->stripe_id && !user()->subscription()->paypal_id)) active @endif">
                        <form action="{{ route('frontend.subscription.checkout') }}" id="stripe_form" method="post">
                            ...
                            <img alt="" class="w-50 pb-xl-3"   src="{{ asset('/frontend/img/cards.webp') }}" >
                        ...
                        <div class="text-center">
                            <img alt="" src="/frontend/img/Stripe.webp" alt="Powered by stripe" class="w-50 p-2" >
                        </div>
                    </div>
