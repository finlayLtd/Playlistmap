...
<div class="flexereamobile">
    <div class="card mb-3">
            ...
            <div class="card-body bg-light">
                <div class="row g-3">
                    <div class="col-12">
                        <label class="form-label d-flex" for="to">To</label>
                        <input class="form-control" name="to" id="to" type="text"
                               value="{{ $playlist->contact_email }}">
                    </div>
...
<style>
    ...
    #gmailbtn
    {
        padding: inherit;    background: #f14236;
    }
    #gmailbtn:hover
    {
        background: #ce3328;
        ...
        $(function() {
            ...
            function changeTemplate(field) {
                ...
                $request.done(function (response, textStatus, jqXHR){
                    if (field === 'message') tinymce.activeEditor.setContent(response.message);
                    else if(field === 'subject') $('#subject').val(response.subject);
                });
            }
        });
    </script>
