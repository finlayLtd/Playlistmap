        ...
        <form id="search-view-form" class="" action="{{ route('frontend.search') }}">
            ...
            <div class="mt-3 w-75 mx-auto">
                ...
                try {
                    ...
                    if ($userData && isset($userData->genres) && $userData->genres !== null) {
                        ?>
                        <h6 class="mb-3" style="text-align: left;">Recommnded for you:</h6>
                        @foreach($userData->genres as $genre)
                        <span class = "badge badge-soft-info" style="background:#ece3ff">
                ...
                ?>
                @endauth
                <h6 class="mb-3 mt-3" style="text-align: left;">Trending:</h6>
        ...
        <div class="table-responsive">
            <table id="main-search-table" class="table border">
                <thead>
                    <tr class="">
                        @if(user()->subscription()->plan->isFree())
                        <th scope="col">Playlist Cover</th>
                                                                ...
                                                                <tr class="{{ $shouldBlur ? 'premium-content' : '' }}">
                                                                    ...
                                                                    <td class="w-25">
                                                                        <!--<button class="" type="button" data-toggle="modal"
                                                                                ...
                                                                                >-->
                                                                            <img style="width: 130px;" src="{{ $playlist->image }}" />
                                                                        <!--</button>-->
...
//                                                                        $(e.target).closest('form').find('#playlist_id').val(playlistId);
