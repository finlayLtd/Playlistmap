<div class="modal fade" id="register_modal" tabindex="-1" aria-labelledby="unlock_playlist_modal"
    ...
    <div class="modal-dialog modal-dialog-centered justify-content-center">      
        <div class="modal-content login-modal position-relative">
            <div class="position-absolute register-modal-close rounded-circle x-button d-flex justify-content-center align-items-center" 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 login-input">
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <button class="btn btn-danger w-100 rounded-pill btn-block mt-3 w-100 rounded-pill" type="submit" name="submit" data-toggle="modal" data-target="#loader"><span class="me-1"><i class="fa-regular fa-paper-plane-top"></i></span>Create Account</button>
