    ...
    <div class="row g-0">
        <div class="col-lg-8 pr-lg-2">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <p class="mb-0 pl-3">Either you or we may terminate this Agreement upon written notice to the other party of a material breach, or if the other party becomes the subject of a petition in insolvency proceedings, bankruptcy, receivership, liquidation or assignment for the benefit of its creditors.</p>
                </div>
            </div>
            <div class="card mb-3">
                <div class="card-header bg-light">
                ...
                <div class="card-body">
                    ...
                    <ol type="1">
                        ...
                        <li>You won’t violate our <a href="../pages/terms/acceptable-use-policy.html">Acceptable use policy</a>, which is part of this Agreement;</li>
                    ...
                    <p class="mb-0 pl-3"> If you think anyone is violating any of these Terms, please <a href="mailto:info@themewagon.com">notify us</a> immediately. If you received spam you think came from a falcon user, we want to <a href="mailto:info@themewagon.com">hear about it</a>. If you think anyone has posted material that violates any copyrights, then you may<a href="mailto:info@themewagon.com"> notify us</a>.</p>
                    <hr class="my-4">
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0 pl-3">You shall defend, indemnify and hold us harmless against claims, actions, proceedings, losses, damages, expenses and costs (including without limitation court costs and reasonable legal fees) arising out of or in connection with your use of the Service (or us taking any action in relation to the Service at your direction), including any claim or action from a recipient of any Content sent by means of the Service.</p>
                    <hr class="my-4">
                    ...
                    <p class="mb-0 pl-3">We won’t be held liable for any delays or failure in performance of any part of the Service, from any cause beyond our control. This includes, but is not limited to, changes to law or regulations, embargoes, fires, earthquakes, floods, strikes, power blackouts, unusually severe weather conditions, and acts of hackers or third-party internet service providers.</p>
                    <hr class="my-4">
                    <p class="fs-0 mb-0 fw-semi-bold">Data processing term</p>
                    <p class="mb-0 pl-3"> To the extent that you are a business and we process personal data on your behalf in providing the Services, the <a href="../pages/terms/data-processing-terms.html">Data processing terms</a> shall apply and are incorporated into these Terms.</p>
                </div>
            </div>
            <div class="card mb-3">
                <div class="card-header bg-light">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0 pl-3">Nothing in these Terms is intended to or shall operate to create a partnership between the parties, or authorize either party to act as agent for the other, and neither party shall have the authority to act in the name or on behalf of or otherwise to bind the other in any way (including, but not limited to, the making of any representation or warranty, the assumption of any obligation or liability and the exercise of any right or power).</p>
                    <hr class="my-4">
                    <h6 class="text-primary">Third party rights</h6>
                    <p class="mb-0 pl-3">These Terms do not confer any rights on any person or party other than you and us.</p>
                    <hr class="my-4">
                    ...
                    <p class="mb-0 pl-3">These Terms are governed by USA law and you can bring legal proceedings in respect of the products in the USA courts. As a consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident. Nothing in these terms and conditions, including this clause 30, affects your rights as a consumer to rely on such mandatory provisions of local law.</p>
                ...
                <div class="card sticky-top">
                    ...
                    <div class="card-body">
                        <div class="terms-sidebar nav flex-column fs--1" id="terms-sidebar">
                            <div class="nav-item"><a class="nav-link px-0" href="#account">Account</a></div>
                            <div class="nav-item"><a class="nav-link px-0" href="#subscriptions">Subscriptions</a></div>
                            <div class="nav-item"><a class="nav-link px-0" href="#termination">Termination</a></div>
                            <div class="nav-item"><a class="nav-link px-0" href="#rules">Rules and abuse</a></div>
                            <div class="nav-item"><a class="nav-link px-0" href="#liability">Liability</a></div>
                            <div class="nav-item"><a class="nav-link px-0" href="#rights">Rights</a></div>
                            <div class="nav-item"><a class="nav-link px-0" href="#instructions">Instructions</a></div>
                        </div>
                    </div>
                </div>
            </div>
